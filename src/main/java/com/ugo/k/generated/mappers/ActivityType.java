...
public class ActivityType extends KRow {
	...
	public ActivityType setId(Long id) {
		this.id = id;
	...
	public ActivityType setCreatedAt(LocalDateTime createdAt) {
	...
	public ActivityType setUpdatedAt(LocalDateTime updatedAt) {
