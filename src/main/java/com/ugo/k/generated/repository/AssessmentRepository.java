...
import com.ugo.k.generated.metadata.AssessmentMetadata;
...
public class AssessmentRepository extends KCrudRepository<Assessment, Long> {
	...
	public Class<?> getKMetadataClass() {
		return AssessmentMetadata.class;
	}
